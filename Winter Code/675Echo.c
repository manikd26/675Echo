...
#pragma config(Motor,  port6,           leftFront,     tmotorVex393TurboSpeed_MC29, openLoop, driveLeft, encoderPort, I2C_1)
#pragma config(Motor,  port7,           leftBack,      tmotorVex393TurboSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port8,           rightFront,    tmotorVex393TurboSpeed_MC29, openLoop, reversed, driveRight, encoderPort, I2C_2)
